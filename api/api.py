...
PRED_LAT = Histogram(
    "prediction_duration_seconds", "Model prediction latency (s)", ["endpoint", "model"]
)
...
def predict_score(
    payload: PredictText, request: Request, _: None = Depends(require_role("admin"))
):
    t0 = time.time()
